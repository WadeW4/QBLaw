...
<html>
                                ...
                                <div id="footer" class="Indent">
                                    <div class="FooterColumn" id="footer-column1">
                                        ...
                                        <div class="FooterColumnText">
                                            <a target="_blank"
                                               href="http://www.facebook.com/pages/Quinn-Banton-LLP/126415110747423"><img
                                                    src="${pageContext.request.contextPath}/resources/images/facebookicon.png" border="0"> Our Facebook Page</a><br/><br/>
                                            <a target="_blank" href="http://twitter.com/quinnbantonllp"><img
                                                    src="${pageContext.request.contextPath}/resources/images/twittericon.png" border="0"> Our Twitter Page</a><br/><br/>
                                            <a target="_blank" href="http://www.linkedin.com/company/2422364"><img
                                                    src="${pageContext.request.contextPath}/resources/images/linkedinicon.png" border="0"> Our LinkedIn Page</a><br/><br/>
                                            <img src="${pageContext.request.contextPath}/resources/images/naela150.png"><br/><br/>
                                            <img src="${pageContext.request.contextPath}/resources/images/Bar-Logos2.jpg"></div>
                                    </div>
                                    ...
                                    <div class="FooterColumn" id="footer-column5">
                                        ...
                                        <form action="#" method="post" id="commentform2" name="commentform2">
                                            ...
                                            <p><input type="text" name="contactname2" id="contactname2" value="" size="22"
                                                      tabindex="1" onFocus="this.className = 'selected'"
                                                      onBlur="this.className = ''"/>
                                                <label for="author2">
                                                    <small>Name (required)</small>
                                                </label></p>
                                            <p><input type="text" name="contactemail2" id="contactemail2" value="" size="22"
                                                      tabindex="2" onFocus="this.className = 'selected'"
                                                      onBlur="this.className = ''"/>
                                                <label for="email2">
                                                    <small>Email (required)</small>
                                                </label></p>
                                            <p><input type="text" name="contactwebsite2" id="contactwebsite2" value="" size="22"
                                                      tabindex="3" onFocus="this.className = 'selected'"
                                                      onBlur="this.className = ''"/>
                                                <label for="url2">
                                                    <small>Website</small>
                                                </label></p>
                                            <p><textarea name="contactmessage2" id="contactmessage2" cols="32" rows="10"
                                                         tabindex="4" onFocus="this.className = 'selected'"
                                                         onBlur="this.className = ''"></textarea></p>
    ...
    <!-- Mirrored from qb-lawfirm.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jan 2015 00:26:39 GMT -->
</html>
