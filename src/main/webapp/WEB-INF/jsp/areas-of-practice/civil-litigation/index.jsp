...
<!-- Mirrored from qb-lawfirm.com/areas-of-practice/civil-litigation/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jan 2015 00:35:04 GMT -->
...
<title>Civil Litigation - Quinn &amp; Banton</title>
<link rel="canonical" href="index.jsp" />
<!-- / Yoast WordPress SEO plugin. -->

<link rel="alternate" type="application/rss+xml" title="Quinn &amp; Banton &raquo; Civil Litigation Comments Feed" href="feed/index.jsp" />
...
<link rel='shortlink' href='../../index1098.html?p=59' />
...
<body class="page page-id-59 page-child parent-pageid-13 page-template-default">
<div id="container">
	<div id="top"></div>
	...
	<div id="breadcrumb">
		...
		<img class='breadcrumb-arrow' src='../../wp-content/themes/neptune/images/breadcrumb_arrow.png' /><div class='breadcrumb-item'>Civil Litigation</div>	</div>
	
	
	<div id="page-header-container">
		<div id="page-header">
			<div class="PageTitle"><h1>Civil Litigation</h1></div>
					</div>
	</div>
...
<ul id="recentcomments"></ul></li>
			...
			<div id="narrowcolumn">
						...
						<div class="entry">
						<p>Civil litigation is the process where non-criminal disputes are resolved through the court process.  This is a very broad area and can involve litigation over trusts, probate estates, car accidents, contracts, and many other types of litigation.  Many times a lawsuit is the last thing our clients want to resort to, but our attorneys are experienced in many areas of law and litigation and stand ready to represent your rights if court is required.</p>
<p id="authorsure-last-updated" class="updated left" itemscope="itemscope" itemtype="http://schema.org/WebPage" itemid="http://qb-lawfirm.com/areas-of-practice/civil-litigation/">By <span style="float:none" class="author vcard"><span class="fn"><a rel="author" href="../../author/admin/index.html" class="authorsure-author-link">admin</a></span></span>.</p>												</div> <!-- entry -->
					</div> <!-- post -->
								<br />
...
<input type='hidden' name='comment_parent' id='comment_parent' value='0' />
			...
			<p style="display: none;"><input type="hidden" id="akismet_comment_nonce" name="akismet_comment_nonce" value="f528b6dcbd" /></p><p style="display: none;"><input type="hidden" id="ak_js" name="ak_js" value="79"/></p>
			</form>
...
<!-- Mirrored from qb-lawfirm.com/areas-of-practice/civil-litigation/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jan 2015 00:35:06 GMT -->
</html>
