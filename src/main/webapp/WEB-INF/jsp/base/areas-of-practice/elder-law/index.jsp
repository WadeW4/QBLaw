...
<!-- Mirrored from qb-lawfirm.com/areas-of-practice/elder-law/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jan 2015 00:32:01 GMT -->
...
<title>Elder Law - Quinn &amp; Banton</title>
<link rel="canonical" href="index.jsp" />
<!-- / Yoast WordPress SEO plugin. -->

<link rel="alternate" type="application/rss+xml" title="Quinn &amp; Banton &raquo; Elder Law Comments Feed" href="feed/index.jsp" />
...
<body class="page page-id-246 page-child parent-pageid-13 page-template-default">
<div id="container">
	<div id="top"></div>
	...
	<div id="breadcrumb">
		...
		<img class='breadcrumb-arrow' src='../../wp-content/themes/neptune/images/breadcrumb_arrow.png' /><div class='breadcrumb-item'>Elder Law</div>	</div>
	
	
	<div id="page-header-container">
		<div id="page-header">
			<div class="PageTitle"><h1>Elder Law</h1></div>
					</div>
	</div>
...
<ul id="recentcomments"></ul></li>
			...
			<div id="narrowcolumn">
						...
						<div class="entry">
						<p>Elder law is the process of educating and presenting planning options that apply to a senior’s unique problems.  Elder law planning can involve qualifying a client forgovernment benefits to help them pay for long term care, such as benefits from the Department of Veterans Affairs (&#8220;VA&#8221;) to help offset some of the costs of care, or arranging one’s affairs so that Medicaid can help pay for a nursing home stay.  Medicaid and VA planning involve working with the laws to set aside assets to help pay for nursing home care, and to pay for things not covered by Medicaid such as caregivers, hearing aids, beauty shop visits, televisions, clothes, shoes, and other personal items; while at the same time preserving as much as possible for the person’s spouse and children.</p>
<p>Elder law strategies will often involve implementing advanced estate planning techniques, such as expanded Durable Power of Attorney documents, specialized Wills, and Irrevocable Asset Protection Trusts.  However, it is important to understand how the implementation of each of these strategies can effect potential benefits from each government program which may be helpful to you and your loved ones.</p>
<p>Many individuals don’t want to face these issues until faced with a long term care crisis, and that’s normal. But planning for these events before they happen will oftentimes give our client&#8217;s a better result than planning during a crisis, plus it will be much less stressful.  Please contact our firm today so we can discuss a customized solution to fit your goals.</p>
...
<p id="authorsure-last-updated" class="updated left" itemscope="itemscope" itemtype="http://schema.org/WebPage" itemid="http://qb-lawfirm.com/areas-of-practice/elder-law/">By <span style="float:none" class="author vcard"><span class="fn"><a rel="author" href="../../author/qblaw/index.html" class="authorsure-author-link">Brian Quinn</a></span></span>.</p>												</div> <!-- entry -->
					</div> <!-- post -->
								<br />
...
<input type='hidden' name='comment_parent' id='comment_parent' value='0' />
			...
			<p style="display: none;"><input type="hidden" id="akismet_comment_nonce" name="akismet_comment_nonce" value="68dde86982" /></p><p style="display: none;"><input type="hidden" id="ak_js" name="ak_js" value="241"/></p>
			</form>
...
<!-- Mirrored from qb-lawfirm.com/areas-of-practice/elder-law/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jan 2015 00:32:10 GMT -->
</html>
