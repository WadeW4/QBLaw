...
<!-- Mirrored from qb-lawfirm.com/areas-of-practice/trust-administration/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jan 2015 00:32:32 GMT -->
...
<title>Trust Administration - Quinn &amp; Banton</title>
<link rel="canonical" href="index.html" />
<!-- / Yoast WordPress SEO plugin. -->

<link rel="alternate" type="application/rss+xml" title="Quinn &amp; Banton &raquo; Trust Administration Comments Feed" href="feed/index.html" />
...
<body class="page page-id-252 page-child parent-pageid-13 page-template-default">
<div id="container">
	<div id="top"></div>
	...
	<div id="breadcrumb">
		...
		<img class='breadcrumb-arrow' src='../../wp-content/themes/neptune/images/breadcrumb_arrow.png' /><div class='breadcrumb-item'>Trust Administration</div>	</div>
	
	
	<div id="page-header-container">
		<div id="page-header">
			<div class="PageTitle"><h1>Trust Administration</h1></div>
					</div>
	</div>
...
<ul id="recentcomments"></ul></li>
			...
			<div id="narrowcolumn">
						...
						<div class="entry">
						<p>If you are the trustee of a trust, you are charged with the management of that legal instrument and the assets owned by it.  Trust administration is the process of taking the steps required by state and federal laws to implement the instructions contained in the trust document itself.  The complexity of this process depends on the provisions of the trust and the types of assets owned by it.  Depending on the type and terms of the trust, beneficiaries must be properly notified of their interests in the trust, trust assets must be invested according to certain standards, debts properly payable from the trust must be paid, creditors must be notified, tax returns must be filed, and the income and assets must be distributed according to the terms of the trust.  The assets must be properly appraised and an inventory must be prepared to determine the proper course of action.</p>
<p>The complexity of the trust administration process may seem daunting, by with the help of experienced legal counsel, the pitfalls of the process can be alleviated or avoided.  Please contact us today for expert guidance throughout this process.</p>
<p id="authorsure-last-updated" class="updated left" itemscope="itemscope" itemtype="http://schema.org/WebPage" itemid="http://qb-lawfirm.com/areas-of-practice/trust-administration/">By <span style="float:none" class="author vcard"><span class="fn"><a rel="author" href="../../author/qblaw/index.html" class="authorsure-author-link">Brian Quinn</a></span></span>.</p>												</div> <!-- entry -->
					</div> <!-- post -->
								<br />
...
<input type='hidden' name='comment_parent' id='comment_parent' value='0' />
			...
			<p style="display: none;"><input type="hidden" id="akismet_comment_nonce" name="akismet_comment_nonce" value="a2cab0f6f0" /></p><p style="display: none;"><input type="hidden" id="ak_js" name="ak_js" value="210"/></p>
			</form>
...
<!-- Mirrored from qb-lawfirm.com/areas-of-practice/trust-administration/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jan 2015 00:32:47 GMT -->
</html>
